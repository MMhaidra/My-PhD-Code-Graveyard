...
"""
templ2.GetXaxis().SetRangeUser(-400,-200)
print("LocalMaximum: ", templ2.GetMaximum())
print("LocalMinimum: ", templ2.GetMinimum())

templ2.GetXaxis().SetRangeUser(-210,10)
print("LocalMaximum: ", templ2.GetMaximum())
print("LocalMinimum: ", templ2.GetMinimum())

templ2.GetXaxis().SetRangeUser(10,180)
print("LocalMaximum: ", templ2.GetMaximum())
print("LocalMinimum: ", templ2.GetMinimum())

templ2.GetXaxis().SetRangeUser(200,260)
print("LocalMaximum: ", templ2.GetMaximum())
print("LocalMinimum: ", templ2.GetMinimum())

templ2.GetXaxis().SetRangeUser(280,400)
print("LocalMaximum: ", templ2.GetMaximum())
print("LocalMinimum: ", templ2.GetMinimum())
"""
